...
import com.example.swoos.dto.MergeResponseDTO;
...
public class MergeFileService {
    ...
    public String update(List<MergeRequestDTO> mergeRequestDTO) {
        for(MergeRequestDTO mergeRequestDTO1 :mergeRequestDTO) {
            ...
            MergeResponseDTO mergeResponseDTO = null;
...
//    public SuccessResponse getHistory() {


//    }

//    public MergedModel update1(MergedModel mergedModel) {
////        DropDownModel dropDownModel= dropDownRepository.findByDescription(mergedModel.getReason());
////        Remarks remarks= remarksRepository.findByRemarks(mergedModel.getRemarks());
//
//        Optional<MergedModel> mergedModel1 = mergedRepository.findById(mergedModel.getMergedId());
//        if (mergedModel1.isPresent()) {
//            // DropDownModel dropDownModel1= dropDownRepository.findById(dropDownModel.getDropdownId());
//
//            // MergedModel mergedModel1=new MergedModel();
////            mergedModel1.get().setReason(dropDownModel.getDescription());
////            mergedModel1.get().setRemarks(remarks.getRemarks());
//            mergedModel1.get().setDropDownModel(mergedModel.getDropDownModel());
//            mergedRepository.save(mergedModel1.get());
//
//        }
//
////        mergedRepository.save(mergedModel);
//        return mergedModel;
//    }
}
