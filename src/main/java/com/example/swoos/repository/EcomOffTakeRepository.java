...
import com.example.swoos.model.EcomOffTake;
...
public interface EcomOffTakeRepository extends JpaRepository<EcomOffTake,Long> {
    ...
    List<EcomOffTake> findAllDataInPreviousMonth();
}
